	...
	public class GoogleSheetsCollection {
		...
		private static bool CheckCardSheetFormat(Sheet sheet) {
			...
			if (headerRow.values[0].StringValue == "id"
					...
					&& headerRow.values[4].StringValue == "leftActionProduction"
					&& headerRow.values[5].StringValue == "leftActionLogistics"
					&& headerRow.values[6].StringValue == "leftActionEconomy"
					&& headerRow.values[7].StringValue == "leftActionSatisfaction"
					&& headerRow.values[8].StringValue == "rightActionText"
					&& headerRow.values[9].StringValue == "rightActionProduction"
					&& headerRow.values[10].StringValue == "rightActionLogistics"
					&& headerRow.values[11].StringValue == "rightActionEconomy"
					&& headerRow.values[12].StringValue == "rightActionSatisfaction"
